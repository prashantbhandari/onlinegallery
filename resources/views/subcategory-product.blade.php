  ...
  <main id="main">
    ...
    <section class="page-header">
      <div class="container">
          <ul class="breadcrumb">
              <li><a href="/">Home</a></li>
              <li><a href="/product/category/{{$sub_category->category->id}}">{{$sub_category->category->name}}</a></li>
              <li><a>{{$sub_category->name}}</a></li>
          </ul>
      </div>
    </section>
   <!--==========================
    ...
    <div class="container-fluid" id="product-small">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 container-fluid" style="padding: 0px; min-height: 500px">
            <section id="resultnumber" class="d-none">
                ...
                <p> Showing<b> {{$sub_category_products->firstItem()}} </b>to<b> {{$sub_category_products->lastItem()}} </b>out of<b> {{$sub_category_products->total()}} </b>products</p>
                </div></br>
              </section>
          <section id="services">
            @foreach ($sub_category_products as $product)
